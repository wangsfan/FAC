...
def main(config, initial_checkpoint):
    ...
    test_dataset = SequenceMVSEC(base_folder='/home/yjy/DATA/DENSE/test_sequence_00_town10',
                                 sequence_length=L,
                                 transform=None,
                                 step_size=L,
    ...
    with torch.no_grad():
        ...
        while idx < N:
            ...
            flops_thop, params = profile(model, inputs=(events, ))
            ...
            print(f"模型运行时间: {elapsed_time} ms")
...
if __name__ == '__main__':
    ...
    path_to_model = 'e2depth_checkpoints/EReFormer_dense_epoch200_000035/model_best.pth.tar'
