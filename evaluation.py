...
def FLAGS():
    ...
    parser.add_argument("--crop_ymax", default=224, type=int)
...
if __name__ == "__main__":
    ...
    for idx in tqdm.tqdm(range(num_it)):
        ...
        display_high_contrast_colormap (idx, predicted_depth, target_depth, colormap = 'terrain', debug=False, folder_name="keshihua")
        # print(debug)
